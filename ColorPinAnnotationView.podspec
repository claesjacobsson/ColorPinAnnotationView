...
Pod::Spec.new do |s|
  ...
  s.version   = "1.0.0"
  s.summary   = "ColorPinAnnotationView can use any color and can be used instead of MKPinAnnotationView."
  ...
  s.source       = { :git => "https://github.com/danielsaidi/ColorPinAnnotationView.git", :tag => "1.0.0" }
